            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">SEO locale</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Ricerca</p>
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Posizionati dove contano
                      </h2>
                      <p className="md:text-md">
                        Quando qualcuno a Milano cerca quello che offri, sei il
                        primo che vede. La ricerca locale è il tuo vantaggio
                        competitivo.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Leggi" variant="secondary">
                          Leggi
                        </Button>
                        <Button
                          title="Altro"
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">Siti web</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      ...
                      <p className="md:text-md">
                        Dal design all'esperienza utente, costruiamo siti veloci
                        e ottimizzati che trasformano i visitatori in clienti
                        reali.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Leggi" variant="secondary">
            ...
            <div className="px-[5%]">
              <div className="container">
                <a href="#" className="flex h-16 w-full items-center underline">
                  ...
                  <h1 className="font-semibold md:text-md">Google Business</h1>
                </a>
                <div className="py-8 md:py-10 lg:py-12">
                  <div className="grid grid-cols-1 gap-y-12 md:items-center md:gap-x-12 lg:grid-cols-2 lg:gap-x-20">
                    <div>
                      <p className="mb-3 font-semibold md:mb-4">Presenza</p>
                      <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
                        Renditi trovabile su Google
                      </h2>
                      <p className="md:text-md">
                        Ottimizziamo il tuo profilo Google Business per
                        aumentare le recensioni, le chiamate dirette e la
                        visibilità sulla mappa locale.
                      </p>
                      <div className="mt-6 flex flex-wrap items-center gap-4 md:mt-8">
                        <Button title="Leggi" variant="secondary">
                          Leggi
